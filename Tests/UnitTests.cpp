    ...
    try
    {
        ...
        // test write UTF16LE
        {
#ifdef _UNICODE
            {
                CText s(_T("Привет"));
                CText path = getcwd(0, 0);
                path += _T("/data/test2_UTF16LE.txt");
        ...
        }
        {
            if(!CText::IsWide())
            {
                CText s(_T("Hello World"));
                CText path = getcwd(0, 0);
                path += _T("/data/test2_UTF16LE_2.txt");
                s.writeFile(path.str(), CText::ENCODING_UTF16LE);
                s.readFile(path.str());
...

        {
            //if(!CText::IsWide())
            {
                CText s(_T("Hello World"));
                CText path = getcwd(0, 0);
                path += _T("/data/test2_UTF16BE_2.txt");
